...
public class GraphGenerator {
	...
	private final Map<Vertex, Integer> distFromStart;
	private final Map<Vertex, Integer> distFromEnd;
	 ...
	 * @param shortestPathEdges the number of edges in the shortest path to be generated
	 */
